...
nameGreeting = nameCheck("Some random name")
...
//CODE HERE
function faveColorFinder (faveColor){
  if(faveColor === "red") {
    return "Red is a great color."
  } else if (faveColor === "black"){
    return "So trendy."
  } else{
...
//CODE HERE
function printAllNames(arrNames){
...
function theEliminator(contestantsArr, loser){
  for(i = 0; i < contestantsArr.length; i++){
...
//CODE HERE
function upperCaseMe (string) {
  console.log(string.toUpperCase())
}

upperCaseMe(sampleString)
...
function chocolateFrogBuyer (priceLimit){
  let frogsBought = Math.floor(priceLimit / frogCost)
  return frogsBought
}
let totalFrogs = chocolateFrogBuyer(10)
...
let totalFrogs2 = chocolateFrogBuyer(10)
console.log(totalFrogs)
...
let arrAscending = ascending(sampleArray)
